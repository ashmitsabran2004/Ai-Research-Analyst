      ...
      <div className="w-full max-w-md">
        <div className="border border-terminal-border bg-terminal-bg p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center font-mono">
              <span className="text-terminal-muted mr-3 mb-2 md:mb-0 w-24 flex-shrink-0">{'>'} confirm:</span>
              <input 
            ...
            >
              {isPending ? '[ REGISTERING ]' : '[ EXEC_REGISTER ]'}
            </button>
          </form>

          <div className="mt-8 text-center border-t border-terminal-border pt-6">
            <Link href="/login" className="font-mono text-xs text-terminal-muted hover:text-terminal-amber transition-colors uppercase tracking-widest">
              have_account? {'>'} login
            </Link>
          </div>
        </div>
